...
<html>
<head>
<title>Administrative Login -Quiz</title>
...
<center><p class="head1">Adminstrative Login </p></center>
<form name="form1" method="post" action="login.php">
<center><table width="490" border="0">
  <tr>
    <td width="106"><span class="style2"></span></td>
    <td width="132"><span class="style2"><span class="head1"><img src="login.jpg" alt="Admin login" width="131" height="155"></span></span></td>
