...
if(isset($_POST['$submit'])=='Save' || (!empty($_POST['subid'])))
{
extract($_POST);
...
{
	echo "<center><br><h2>You are not Logged On Please Login to Access this Page</h2></center>";
...
<form name="form1" method="post" onSubmit="return check();">
  <table width="58%"  border="0" align="center">
    <tr>
	  ...
	  <select name="subid">
<?php
$rs=mysql_query("Select * from subject order by  sub_name",$cn);
